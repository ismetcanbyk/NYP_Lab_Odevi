...
public class Enerji extends Student {

    public Enerji(String ogrenciAd, String ogrenciSoyad, int entryDate, String fakulte) {
        super(ogrenciAd, ogrenciSoyad, entryDate, fakulte);
        setBolum("Enerji Sistemleri Mühendisliği");
    }
